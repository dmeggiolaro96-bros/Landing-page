...
- **Cartiglio**: il nome del progettista e i dettagli non necessari (data, scala, formato) sono stati rimossi con un rettangolo bianco disegnato direttamente sull'immagine di sfondo (prima di convertirla in base64), lasciando intatti logo aziendale e titolo dello schema.
